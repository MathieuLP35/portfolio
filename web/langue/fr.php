<?php
    ...
    define("_PRESENTATION","Je m'appelle Mathieu Le Petitcorps, j'ai commencé à m'intéressé au développement web il y a quelques années lors de création de serveur sur différent jeux vidéos avec des amis ...
    ...
    define("_RCOCHE","En cochant cette case, vous acceptez la <a href='page/mention.html'>politique de confidentialité</a> de ce site");
    define("_RGO","Envoyer");
    define("_RMAIL","Votre Email *");
    define("_RNAME","Votre Nom *");
    define("_RMAILOBJECT","Objet de votre email *");
    ...
    define("_CCONNECTER","Se connecter");
    define("_CEMAIL","Email");
    define("_CPASSWORD","Mot de passe");
    define("_CENVOI","Envoyer");
