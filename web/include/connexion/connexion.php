...
<div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title"><?php echo _CCONNECTER; ?></h4>
      ...
      <div class="modal-body">
        <form method="POST" action="include/connexion/exec_connexion.php" class="needs-validation" novalidate="novalidate">
            <div class="form-group">
                <input type="email" class="form-control" id="mail" placeholder="<?php echo _CEMAIL; ?>" name="mail" required="required" />
            </div>
            <div class="form-group">
                <input type="password" class="form-control" id="mdp" placeholder="<?php echo _CPASSWORD; ?>" name="mdp" required="required" />
            </div>
